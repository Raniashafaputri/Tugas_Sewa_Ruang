          ...
          <div className="flex justify-between items-center mt-4">
            <div>
              <button
                ...
                className={`px-3 py-1 mr-2 rounded-md bg-blue-500 text-white ${currentPage === 1 ? "opacity-50 cursor-not-allowed" : ""}`}
              >
              ...
              <button
                ...
                className={`px-3 py-1 rounded-md bg-blue-500 text-white ${currentPage === Math.ceil(TambahanPeminjaman.length / itemsPerPage) ? "opacity-50 cursor-not-allowed" : ""}`}
              >
